...
LOAD DATA INPATH '/mnt/data/ratings.csv' OVERWRITE INTO TABLE ratings;
...
LOAD DATA INPATH '/mnt/data/movies.csv' OVERWRITE INTO TABLE movies;
...
LOAD DATA INPATH '/mnt/data/tags.csv' OVERWRITE INTO TABLE tags;
...
LOAD DATA INPATH '/mnt/data/links.csv' OVERWRITE INTO TABLE links;
